...
import { View, Dimensions, Image, ImageBackground, Text, StyleSheet, FlatList, TouchableWithoutFeedback } from "react-native";
...
export default function SearchScreen({navigation}){
    return(
        <View style = {{flex : 1, marginBottom : 30, paddingTop : 20}}>
            <SearchComponent/>
